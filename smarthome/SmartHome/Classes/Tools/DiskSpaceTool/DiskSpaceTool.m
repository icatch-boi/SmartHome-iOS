...
+ (NSString *)transformStringFromMBytes:(unsigned long long)mbyteCount {
    float numberOfBytes = mbyteCount;
    int multiplyFactor = 0;
    
    NSArray *tokens = [NSArray arrayWithObjects:@"MB",@"GB",@"TB",@"PB",@"EB",@"ZB",@"YB",nil];
