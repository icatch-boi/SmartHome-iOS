...
//        [self.menuTableView flashScrollIndicators];//显示滚动条
        ...
        [_menuTableView selectRowAtIndexPath:[NSIndexPath indexPathForRow:_currentRow inSection:0] animated:NO scrollPosition:UITableViewScrollPositionNone];
        [_menuTableView scrollToRowAtIndexPath:[NSIndexPath indexPathForRow:_currentRow inSection:0] atScrollPosition:UITableViewScrollPositionTop animated:NO];
...
//    cell.selectedBackgroundView = v;
    ...
    cell.textLabel.font = self.btnSender.titleLabel.font;
...
- (void) myDelegate {
    if (_delegate && [_delegate respondsToSelector:@selector(setDropDownDelegate:)]) {
