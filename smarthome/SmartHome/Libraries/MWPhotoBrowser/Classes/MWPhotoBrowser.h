...
@interface MWPhotoBrowser : UIViewController <UIPopoverControllerDelegate, UIScrollViewDelegate, UIActionSheetDelegate, MFMailComposeViewControllerDelegate, AppDelegateDelegate>
