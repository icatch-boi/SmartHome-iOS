...
#define KMainW [UIScreen screenWidth]
#define KMainH [UIScreen screenHeight]
...
{
    //遮盖window
    _cover = [[UIWindow alloc] initWithFrame:[UIScreen screenBounds]];
    _cover.windowLevel = UIWindowLevelAlert;
    _cover.hidden = NO;
    
    //window视图
    UIView *view = [[UIView alloc] initWithFrame:[UIScreen screenBounds]];
    [_cover addSubview:view];
    self.view = view;
    
    //遮盖视图
    UIView *backview = [[UIView alloc] initWithFrame:[UIScreen screenBounds]];
