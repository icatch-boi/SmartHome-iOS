...
#pragma mark - - - 扫描外部View的创建
    ...
    [light_button setTitle:NSLocalizedString(@"kOpenTheLampTips", nil) forState:UIControlStateNormal];
    [light_button setTitle:NSLocalizedString(@"kCloseTheLampTips", nil) forState:UIControlStateSelected];
